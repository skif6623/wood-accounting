...
// import {setRoundwoodArray, setBoardArray, WoodItem, DescItem} from "../redux/roundWoodSlice";
...
// 					<input
// 						type="text"
// 						value={roundwoodFilter}
// 						onChange={handleRoundwoodFilterChange}
...
// 							.map(item => (
// 								<li key={item.id}>
// 									Ширина: {item.width}, Висота: {item.height}, Довжина: {item.length}, Кількість: {item.amount}, Тип:{" "}
// 									{item.type}
// 									<input type="number" value={inputAmount} onChange={e => setInputAmount(e.target.value)} />
// 									<button onClick={() => handleItemAmountChange(item)}>Застосувати</button>
// 								</li>
